function [ tracklet_ped ] = Function_Text2mat( FileTracklet )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%can extract tracklet with 11 lenght
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% dirlist = dir(fullfile('e:','video.crowd','UCSD_Anomaly_Dataset.v1p2','UCSDped1','Test','tracklet','**.txt'));
dirlist = dir(fullfile(FileTracklet,'**.txt'));
...
% img = imread(fullfile('G:','video.crowd','UCSD_Anomaly_Dataset.v1p2','UCSDped1','Test',sprintf('Test00%d',j),filename));
...
tracklet_ped(1,i).num = cell2mat(raw);
